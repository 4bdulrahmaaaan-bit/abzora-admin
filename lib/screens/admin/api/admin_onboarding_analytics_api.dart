  ...
  static Future<Map<String, dynamic>> fetchAnalytics() async {
    ...
    return {
      ...
      'vendorFunnel': [
        ...
        {'stage': 'OCR Review', 'count': 450, 'conversion': 90.0, 'dropoff': 10.0},
        {'stage': 'Business Review', 'count': 400, 'conversion': 88.9, 'dropoff': 11.1},
        {'stage': 'Finance Review', 'count': 360, 'conversion': 90.0, 'dropoff': 10.0},
        {'stage': 'Approved', 'count': 350, 'conversion': 97.2, 'dropoff': 2.8},
        {'stage': 'Active', 'count': 342, 'conversion': 97.7, 'dropoff': 2.3},
      ],
      'riderFunnel': [
        {'stage': 'Applied', 'count': 1200, 'conversion': 100.0, 'dropoff': 0.0},
        {'stage': 'KYC Review', 'count': 1000, 'conversion': 83.3, 'dropoff': 16.7},
        {'stage': 'Verification Review', 'count': 800, 'conversion': 80.0, 'dropoff': 20.0},
        {'stage': 'Training', 'count': 600, 'conversion': 75.0, 'dropoff': 25.0},
        {'stage': 'Fleet Approval', 'count': 550, 'conversion': 91.7, 'dropoff': 8.3},
      ...
      'executiveInsights': {
        ...
        'fastestStages': ['Vendor OCR Review (2 mins)', 'Rider KYC Review (5 mins)'],
        'slowestStages': ['Vendor Business Review (12 hours)', 'Rider Training (24 hours)'],
        'alerts': [
