...
class ReturnsApi {
  ...
  Future<Map<String, dynamic>> getReturns({
    ...
    final payload = await _backendApiClient.get(
      '/vendor/returns?page=$page&limit=$limit',
      authenticated: true,
    );
  ...
  Future<Map<String, dynamic>> getRefunds({
    ...
    final payload = await _backendApiClient.get(
      '/vendor/refunds?page=$page&limit=$limit',
      authenticated: true,
    );
    return payload as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> getExchanges({
    ...
    final payload = await _backendApiClient.get(
      '/vendor/exchanges?page=$page&limit=$limit',
      authenticated: true,
    );
    return payload as Map<String, dynamic>;
  }
