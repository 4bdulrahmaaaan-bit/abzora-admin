...
class CouponApi {
  ...
  Future<List<Map<String, dynamic>>> getCoupons() async {
    final payload = await _backendApiClient.get('/vendor/coupons', authenticated: true);
  ...
  Future<Map<String, dynamic>> createCoupon(Map<String, dynamic> data) async {
    final payload = await _backendApiClient.post('/vendor/coupons', authenticated: true, body: data);
    return payload as Map<String, dynamic>;
  }

  Future<void> updateCouponStatus(String id, String status) async {
    await _backendApiClient.post('/vendor/coupons/$id/status', authenticated: true, body: {'status': status, '_method': 'PATCH'});
  }
}
