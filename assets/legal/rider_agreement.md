...
1. Rider shall complete delivery tasks responsibly and in compliance with safety and legal norms.
2. Rider shall use app tracking and verification mechanisms honestly.

## 4. Commercial Terms
1. Earnings are based on accepted/completed tasks and published payout structures.
2. Incentives and penalties may be applied per applicable policy.

## 5. Conduct and Safety
1. Rider must avoid misconduct, harassment, intoxication, and unsafe behavior.
